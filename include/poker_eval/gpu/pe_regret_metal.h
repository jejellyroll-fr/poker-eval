/* pe_regret_metal.h - Metal ragged strategy and regret-update adapter. */

#ifndef POKER_EVAL_GPU_PE_REGRET_Metal_H
#define POKER_EVAL_GPU_PE_REGRET_Metal_H
...
typedef struct pe_regret_metal_context_t pe_regret_metal_context_t;
...
} pe_regret_metal_update_batch_t;
...
#endif /* POKER_EVAL_GPU_PE_REGRET_Metal_H */

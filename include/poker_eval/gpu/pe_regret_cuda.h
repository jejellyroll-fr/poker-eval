/* pe_regret_cuda.h - CUDA ragged strategy and regret-update adapter. */

#ifndef POKER_EVAL_GPU_PE_REGRET_CUDA_H
#define POKER_EVAL_GPU_PE_REGRET_CUDA_H
...
typedef struct pe_regret_cuda_context_t pe_regret_cuda_context_t;
...
#endif /* POKER_EVAL_GPU_PE_REGRET_CUDA_H */

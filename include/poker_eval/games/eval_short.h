...
ShortDeck_ShortRules_EVAL_N(ShortDeck_CardMask cards, int n_cards)
{
  ...
  case StdRules_HandType_FLUSH:
    if (n_ranks >= 5)
    {
      if ((SS & ShortRules_9_STRAIGHT) == ShortRules_9_STRAIGHT)
        return HandVal_HANDTYPE_VALUE(ShortRules_HandType_STFLUSH) + HandVal_TOP_CARD_VALUE(ShortDeck_Rank_9);
    ...
    if (n_ranks >= 5)
    {
      if (nBitsTable[SS] >= 5)
      {
        if ((SS & ShortRules_9_STRAIGHT) == ShortRules_9_STRAIGHT)
          ...
          return HandVal_HANDTYPE_VALUE(ShortRules_HandType_FLUSH) + topFiveCardsTable[SS];
      }
      else if (nBitsTable[SC] >= 5)
      {
        if ((SC & ShortRules_9_STRAIGHT) == ShortRules_9_STRAIGHT)
          ...
          return HandVal_HANDTYPE_VALUE(ShortRules_HandType_FLUSH) + topFiveCardsTable[SC];
      }
      else if (nBitsTable[SD] >= 5)
      {
        if ((SD & ShortRules_9_STRAIGHT) == ShortRules_9_STRAIGHT)
          ...
          return HandVal_HANDTYPE_VALUE(ShortRules_HandType_FLUSH) + topFiveCardsTable[SD];
      }
      else if (nBitsTable[SH] >= 5)
      {
        if ((SH & ShortRules_9_STRAIGHT) == ShortRules_9_STRAIGHT)
          ...
          return HandVal_HANDTYPE_VALUE(ShortRules_HandType_FLUSH) + topFiveCardsTable[SH];
      }
    };
  ...
  case StdRules_HandType_NOPAIR:
    if ((ranks & ShortRules_9_STRAIGHT) == ShortRules_9_STRAIGHT)
      return HandVal_HANDTYPE_VALUE(ShortRules_HandType_STRAIGHT) + HandVal_TOP_CARD_VALUE(ShortDeck_Rank_9);
    else
      return ShortHandTypeMap[stdHandType] + stdCards;
    break;

...
#define Deck_printMask(m) GenericDeck_printMask(&CurDeck, ((void *)&(m)))

#define Deck_maskString(m) GenericDeck_maskString(&CurDeck, ((void *)&(m)))

#define Deck_numCards(m) GenericDeck_numCards(&CurDeck, ((void *)&(m)))
...
#define DmaskToString(d, m, s)                                                 \
  (GenericDeck_maskString(&(d), ((void *)&(m)), (s)))

extern POKEREVAL_EXPORT char *GenericDeck_cardString(Deck *deck, int cardIndex);
extern POKEREVAL_EXPORT int GenericDeck_printMask(Deck *deck, void *cardMask);
extern POKEREVAL_EXPORT int GenericDeck_maskToString(Deck *deck, void *cardMask,
                                                     char *outString);
extern POKEREVAL_EXPORT char *GenericDeck_maskString(Deck *deck,
                                                     void *cardMask);
extern POKEREVAL_EXPORT int GenericDeck_printCard(Deck *deck, int cardIndex);
extern POKEREVAL_EXPORT int GenericDeck_numCards(Deck *deck, void *cardMask);

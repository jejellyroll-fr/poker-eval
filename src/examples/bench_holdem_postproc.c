/*
 * bench_holdem_postproc.c - Mesure dédiée post-traitement Hold'em N joueurs
 * Compare latence avec/sans SIMD (PE_DISABLE_SIMD) pour enumSampleBatched.
 *
 * Usage: bench_holdem_postproc [players] [niter]
 *   players: 4 ou 6 (défaut: 4)
 *   niter:   nombre d'itérations Monte Carlo (défaut: 200000)
 */
...
int main(int argc, char** argv) {
    ...
    /* Board: flop aléatoire, on complète turn/river dans le MC */

...
void Universal_ConvertStdToJoker(StdDeck_CardMask std, JokerDeck_CardMask *joker) {
...
void Universal_ConvertJokerToStd(JokerDeck_CardMask joker, StdDeck_CardMask *std) {
...
void Universal_CardMask_SET(UniversalCardMask *mask, int card, deck_type_t type) {
  if (type == UNIVERSAL_DECK_STANDARD) {
...
int Universal_CardMask_CARD_IS_SET(UniversalCardMask mask, int card, deck_type_t type) {
  if (type == UNIVERSAL_DECK_STANDARD) {

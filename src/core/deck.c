...
int GenericDeck_maskToString(Deck *deck, void *cardMask, char *outString) {
...
int GenericDeck_printMask(Deck *deck, void *cardMask) {
  char outString[300];
  int r;
...
char *GenericDeck_maskString(Deck *deck, void *cardMask) {
...
int GenericDeck_numCards(Deck *deck, void *cardMask) {
  return (*deck->numCards)(cardMask);
}

char *GenericDeck_cardString(Deck *deck, int cardIndex) {
...
int GenericDeck_printCard(Deck *deck, int cardIndex) {
  char outString[16];
  int ret;

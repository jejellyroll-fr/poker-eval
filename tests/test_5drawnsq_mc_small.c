/* test_5drawnsq_mc_small.c - sanity check for 5-draw no-qualifier Monte Carlo (JokerDeck) */
...
int main(void) {
    ...
    int iters = 200;
    int rv = enumSample(game_5drawnsq, pockets, board, dead, 2, 0, iters, 0, &result);
    if (rv != 0) {
    ...
    printf("5-drawnsq MC small test passed.\n");
    return 0;
}

...
int main(void) {
    ...
    printf("\n=== Conclusion ===\n");
    printf("The platform allocator provides guaranteed alignment.\n");
    printf("Static arrays use the compiler alignment attribute.\n");

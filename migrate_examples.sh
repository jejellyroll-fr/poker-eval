#!/bin/bash
# Script de migration automatique des examples vers headers canoniques

echo "=== Migration des Examples vers Headers Canoniques ==="

# Trouver tous les fichiers C dans examples/
...
echo "✓ Tous les examples utilisent maintenant poker_eval/poker_eval.h"
